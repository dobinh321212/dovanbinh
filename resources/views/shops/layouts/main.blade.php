...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
        ...
        <!-- //for-mobile-apps -->
        <link href="fontend/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
        <link href="fontend/css/style.css" rel="stylesheet" type="text/css" media="all" />
        <!-- font-awesome icons -->
        <link href="fontend/css/font-awesome.css" rel="stylesheet" type="text/css" media="all" />
        <!-- //font-awesome icons -->
        <!-- js -->
        <script src="fontend/js/jquery-1.11.1.min.js"></script>
        <!-- //js -->
        <link href='//fonts.googleapis.com/css?family=Ubuntu:400,300,300italic,400italic,500,500italic,700,700italic' rel='stylesheet' type='text/css'>
        <link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
        <!-- start-smoth-scrolling -->
        <script type="text/javascript" src="fontend/js/move-top.js"></script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="user-menu">
                    <ul>
                        <li><a href="#"><i class="fa fa-user"></i> Tải Khoản</a></li>
                        ...
                        <li><a href="http://dovanbinh.com/admin/login"><i class="fa fa-user"></i> Đăng nhập</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="header-right">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small">
                            <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">Ngôn Ngữ :</span><span class="value">VN </span><b class="caret"></b></a>
                            <ul class="dropdown-menu">
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="./"><img src="fontend/images/logo.png"></a></h1>
                </div>
            </div>
...
<script src="fontend/js/jquery.sticky.js"></script>
...
<!-- Slider -->
<script type="text/javascript" src="fontend/js/bxslider.min.js"></script>
<script type="text/javascript" src="fontend/js/script.slider.js"></script>
