...
<main>
    <section class="container">
                    ...
                    <div class="section-filter-item opened">
                        ...
                        <div class="section-filter-fields">
                            <ul class="section-filter-color">
                                <li class="active"><img src="fontend/img/color/red.jpg" alt="Red"></li>
                                <li><img src="fontend/img/color/blue.jpg" alt="Blue"></li>
                                <li><img src="fontend/img/color/green.jpg" alt="Green"></li>
                                <li><img src="fontend/img/color/yellow.jpg" alt="Yellow"></li>
                                <li><img src="fontend/img/color/purple.jpg" alt="Purple"></li>
                            </ul>
                        </div>
                    </div>
                    <div class="section-filter-item opened">
        ...
        <div class="section-cont">
            ...
            <h1 class="main-ttl"><span>...</span></h1>
            <div class="prod-items section-items">
                ...
                <div class="prod-i">
                    ...
                    <div class="prod-i-top">
                        ...
                        <p class="prod-i-info">
                            <a href="#" class="prod-i-favorites"><span>Thích</span><i class="fa fa-heart"></i></a>
                    ...
                    <div class="prod-i-skuwrapcolor">
                        <ul class="prod-i-skucolor">
                            <li class="bx_active"><img src="fontend/img/color/red.jpg" alt="Red"></li>
                            <li><img src="fontend/img/color/blue.jpg" alt="Blue"></li>
                        </ul>
                    </div>
                </div>
